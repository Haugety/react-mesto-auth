      ...
      <div className="popup__container popup__container_infotool">
        ...
        {type
          ? <>
              ...
              <h3 className="popup__title popup__title_infotool">Вы успешно зарегистрировались!</h3>
            </>
          : <>
              <svg className="popup__signup-icon" width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="popup__title popup__title_infotool">Что-то пошло не так! Попробуйте еще раз.</h3>
            </>}
      </div>
    </section>
  );
